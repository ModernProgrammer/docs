...
description: "This document was last updated on Dec 30, 2024 AEST"
---
...
2024 Update: The release of the Pro version means you will be able to store your reference images (and final images) via firebase, which we have access to. This is so you can use multiple devices and have them sync via the cloud. These images are linked to an ID, not an email. We don't know who you are, and still don't know your password. This is purely a function so you can move devices without a problem and use this as a longer term storage solution.

***Most apps will store all of this data locally, so why are we collecting it on a database? Why do you need an account to use our app?***
...
If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may send an email to [admin@nossaflex.io](mailto:admin@nossaflex.io)